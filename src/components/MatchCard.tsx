                ...
                {isEditingAddress ? (
                  <div style={{ display: 'flex', gap: '0.5rem', width: '100%' }}>
                    <input 
                      ...
                      style={{ flex: 1, padding: '0.4rem', fontSize: '0.85rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}
                    />
                    <button onClick={handleSaveAddress} className="btn" style={{ padding: '0.4rem', background: 'var(--success)', color: 'white', minWidth: '32px' }}>✓</button>
                    <button onClick={() => setIsEditingAddress(false)} className="btn" style={{ padding: '0.4rem', background: '#f1f5f9', minWidth: '32px' }}>✕</button>
                  </div>
                ) : (
                  <>
                ...
                {!showMapSelection ? (
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      <a 
                        href={`waze://?q=${encodeURIComponent(match.venueAddress || match.venue)}&navigate=yes`}
                        onClick={(e) => {
                          const webUrl = `https://www.waze.com/ul?q=${encodeURIComponent(match.venueAddress || match.venue)}&navigate=yes`;
